...
| 14 | `leads` + événements CRM + actions CRM + liens vers `sales_calls`/`sales` | CRM Aujourd’hui, Pipeline, Leads, Actions, Appels, KPI CRM, Dashboard et projections Diagnostic/Roadmap |
