...
export const EN_LEVER_GUIDE_COPY: Record<string, GuideCopy> = {
  lead_magnet: {
    explanation:
      "A lead magnet is a free resource — a PDF, mini-course, checklist or audit — exchanged for a prospect's email address. It turns cold traffic into an audience you can nurture instead of losing visitors after one session.\n\nThe best lead magnet solves one precise problem for your ideal customer, can be consumed in under 15 minutes and naturally points toward your offer.\n\nIn practice, this could be a checklist such as “5 mistakes blocking your clients” or a quick audit that gives someone a first result and makes them want to go further with you.",
    estTimeLabel: "2–4h",
  },
  email_marketing: {
    explanation:
      "Email marketing is the ongoing relationship with your list: a welcome sequence when someone subscribes, followed by regular messages that inform, engage and sell. It is one of the lowest-cost channels once it is running because you do not pay again to reach someone who already gave you their email.\n\nMost people do not buy at the first touch. Email keeps them warm until they are ready, and a well-built welcome sequence can generate sales automatically.\n\nIn practice: 3 to 5 automated emails over the days after signup, then weekly or biweekly emails with useful content and reminders about your offer.",
    estTimeLabel: "3–5h for the welcome sequence",
  },
  newsletter: {
    explanation:
      "A newsletter is a recurring weekly or biweekly message that keeps the relationship with your list alive outside automated sequences: what you are learning, what you see in your clients and your point of view on the market.\n\nIt keeps your audience warm between offers. Without regular contact, people forget you and your next sales email arrives to a cold list.\n\nIn practice: one short email each week with an idea, observation or useful link, plus an occasional low-pressure reminder of your offer.",
    estTimeLabel: "1–2h per week, ongoing",
  },
  seo_blog: {
    explanation:
      "A blog and SEO content answer the questions your prospects type into Google, on your own site, so the content can keep attracting them for months or years.\n\nIt is the acquisition channel that can continue bringing traffic after publication. Unlike a social post that disappears quickly, a useful article can rank continuously while demonstrating your expertise to people who do not know you yet.\n\nIn practice: one article answering one specific question your ideal customer has, optimized for the search term and linked to your lead magnet or offer.",
    estTimeLabel: "3–6 months before the first organic results",
  },
  podcast: {
    explanation:
      "A podcast is a regular audio format, solo or interview-based, that lets you develop ideas in depth and build a close relationship with your audience over a longer listening time than a post or short video.\n\nLong-form audio builds familiarity and trust, and interviews can expand your reach through your guests' audiences.\n\nIn practice: a clear weekly or biweekly format published on listening platforms and repurposed into short clips for social media.",
    estTimeLabel: "3–5h per episode",
  },
  retargeting: {
    explanation:
      "Retargeting shows targeted ads to people who already visited your site, sales page or videos without converting. It is advertising to a warm audience rather than to strangers.\n\nMost visitors do not convert on their first visit. Retargeting can therefore be one of the most efficient campaigns because it reaches people who have already shown real interest.\n\nIn practice: install a pixel, create an audience of recent visitors and show a small-budget ad that reminds them of your offer or answers a common objection.",
    estTimeLabel: "1–2h to set up",
  },
  referral: {
    explanation:
      "A referral system encourages current customers to recommend you, with or without a reward such as a bonus or renewal discount. It turns customer satisfaction into an active acquisition channel instead of relying on spontaneous word of mouth.\n\nA lead recommended by someone they trust starts with confidence no ad can buy, and acquisition cost is close to zero.\n\nIn practice: ask at the right moment, just after a result or testimonial, with a simple question and an optional reward.",
    estTimeLabel: "30 min to set up the process",
  },
  ads: {
    explanation:
      "Paid advertising buys predictable visibility on Meta, Google, TikTok or LinkedIn instead of relying only on organic reach. It is a volume lever: once your funnel converts, every euro spent can become a measurable investment.\n\nIt lets you grow acquisition without growing your content workload, but it is also risky when your closing process is not solid: paying for leads you cannot convert burns cash.\n\nIn practice: start with a modest test budget on one channel, one clear offer and close tracking of cost per lead so you can scale or stop quickly.",
    estTimeLabel: "1–2 weeks for the first campaign",
  },
  vsl: {
    explanation:
    ...
    estTimeLabel: "1–2 weeks (script + recording)",
  },
  webinar: {
    explanation:
      "A webinar is a live or semi-live session where you teach something concrete for 45 to 90 minutes and present your offer at the end. It combines valuable content and selling in one session.\n\nThe live format creates engagement and urgency that an email or post cannot reproduce. People who stay to the end are already invested and are more likely to buy.\n\nIn practice: a precise result promise, a teaching segment that delivers a real win and an offer with a deadline or time-limited bonus.",
  ...
  sequence_relance_non_acheteurs: {
    ...
    estTimeLabel: "2–3h for the sequence",
  },
  order_bump: {
    explanation:
  ...
  downsell: {
    explanation:
      "A downsell is a lower-priced or lighter alternative offered after someone refuses your main offer. It captures some of the “not at that price” or “not with that commitment” decisions that would otherwise become zero revenue.\n\nA well-designed downsell recovers part of the value already created by the conversation without weakening the main offer.\n\nIn practice: a shorter engagement, fewer modules or less support, offered immediately after a refusal in a call or on the checkout page.",
    estTimeLabel: "1–2h to define the offer",
  },
  garantie: {
    explanation:
      "A guarantee is a clear commitment on your sales page or during a call — a refund, result guarantee or trial period — that reduces the prospect's perceived risk.\n\nThe unspoken objection is often “what if this does not work for me?”. A precise guarantee moves part of that risk away from the buyer and can unlock a hesitant decision.\n\nIn practice: one specific, unambiguous sentence shown clearly on the sales page and repeated during the call.",
  ...
  preuve_sociale_page: {
    ...
    estTimeLabel: "1–2h to collect and add them",
  },
  upsell_ascension: {
    explanation:
    ...
    estTimeLabel: "3–5h to define the offer and script",
  },
  onboarding_structure: {
    explanation:
      "Onboarding structure is the journey a customer experiences in the first days after purchase: access to resources, a welcome message or call and clear expectations. It determines whether they start with confidence or confusion.\n\nA clear onboarding reduces early drop-off and refunds. Customers who know exactly what to do start faster, get results sooner and are more likely to stay and provide a testimonial.\n\nIn practice: an automatic welcome message, one central resource hub and one clear first action within 48 hours.",
    estTimeLabel: "2–4h to structure the journey",
  },
  collecte_temoignages_systematique: {
    explanation:
      "Systematic testimonial collection is a repeatable process that asks for customer feedback at key moments instead of waiting for customers to remember on their own.\n\nSocial proof is powerful but gets stale when it depends on a few testimonials reused everywhere. A regular process gives you a steady flow of current proof aligned with your offer.\n\nIn practice: send a request after a milestone with two or three guided questions rather than an open “what did you think?” prompt.",
    estTimeLabel: "1h to set up the process",
  },
  communaute_clients: {
    explanation:
      "A customer community is a dedicated space — a private group, forum or Discord/Slack server — where customers can exchange, ask questions and help one another in addition to direct support.\n\nAn active community improves retention and reduces one-to-one support load. Customer wins also motivate the rest of the group.\n\nIn practice: start with a simple platform, a few rules and regular participation until the community becomes self-sustaining.",
    estTimeLabel: "1–2h to set up, then regular presence",
  },
  reactivation_anciens_clients: {
    ...
    estTimeLabel: "1–2h for the first reactivation campaign",
  },
};

const EN_STARTER_PLAN_COPY: Record<string, Record<number, StarterStepCopy>> = {
  email_marketing: {
    1: { title: "Choose an email marketing tool", detail: "MailerLite, ConvertKit or Brevo are good places to start — free or inexpensive for a few thousand contacts." },
    2: { title: "Define your welcome sequence (Falco can help write it)", detail: "Create 3 to 5 automated emails: who you are, the transformation you offer, a client story and your offer." },
    3: { title: "Send your first email", detail: "Email your current list, even if it is small — sending is how you learn what works." },
  ...
  seo_blog: {
    1: { title: "List 5–10 questions your prospects ask", detail: "Your discovery calls and messages are often the best source of topics." },
  ...
  sequence_relance_non_acheteurs: {
    ...
    2: { title: "Write the sequence (Falco can help)", detail: "Create 3 to 5 emails over 5–7 days, each handling a different objection." },
  ...
  garantie: {
    ...
    2: { title: "Write the exact sentence (Falco can help)", detail: "It should be precise and unambiguous — vague guarantees create doubt." },
  ...
  communaute_clients: {
    ...
    4: { title: "Be present regularly at first", detail: "Early active facilitation helps the community become self-sustaining." },
  },
  reactivation_anciens_clients: {
