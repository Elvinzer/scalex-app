...
export const LEVER_BENCHMARK_INFO_EN: Record<string, LeverBenchmarkInfo> = {
  lead_magnet: { whatIsThis: "A free resource such as a PDF, video or training that people exchange for their email on a dedicated page.", centralLabel: "6 to 12 %", badMax: 0.05, okMax: 0.09, excellentAt: 0.15 },
  email_marketing: { whatIsThis: "Regular emails sent to your list to sell and keep customers engaged.", centralLabel: "35 to 43% open rate", badMax: 0.25, okMax: 0.35, excellentAt: 0.43 },
  newsletter: { whatIsThis: "Regular content emails sent to your list outside automated sales sequences.", centralLabel: "2 to 3% click rate", badMax: 0.02, okMax: 0.03, excellentAt: 0.05 },
  seo_blog: { whatIsThis: "Organic content such as blog posts that attracts visitors without paid advertising.", centralLabel: "2 to 5% visitor to lead", badMax: 0.02, okMax: 0.05, excellentAt: 0.1 },
  podcast: { whatIsThis: "A podcast you host to build an audience and generate leads." },
  retargeting: { whatIsThis: "Ads shown to visitors who have not bought yet.", centralLabel: "0.7 to 1.2% click rate", badMax: 0.005, okMax: 0.007, excellentAt: 0.012 },
  referral: { whatIsThis: "A program that encourages customers to recommend your offer to people they know.", centralLabel: "3 to 5% referred visit to purchase", badMax: 0.02, okMax: 0.03, excellentAt: 0.08 },
  ads: { whatIsThis: "Paid advertising (Meta, Google, TikTok, LinkedIn) to generate leads or sales quickly." },
  webinar: { whatIsThis: "A live online event to teach something useful and present your offer at the end.", centralLabel: "45 to 60% live attendance", badMax: 0.35, okMax: 0.5, excellentAt: 0.6 },
  order_bump: { whatIsThis: "A low-priced complementary offer shown just before payment.", centralLabel: "10 to 30% (provisional estimate, low confidence)", badMax: 0.1, okMax: 0.2, excellentAt: 0.3 },
  downsell: { whatIsThis: "A lower-priced alternative offered when a customer declines your main offer." },
  garantie: { whatIsThis: "A formal commitment such as a refund or guaranteed result that reduces perceived prospect risk." },
  preuve_sociale_page: { whatIsThis: "Customer testimonials shown on your sales page to reassure prospects before purchase." },
  upsell_ascension: { whatIsThis: "A higher-priced offer presented just after purchase to increase customer value.", centralLabel: "2 to 12% acceptance", badMax: 0.02, okMax: 0.06, excellentAt: 0.12 },
  onboarding_structure: { whatIsThis: "A structured onboarding process that helps a new customer get started with your product." },
  collecte_temoignages_systematique: { whatIsThis: "A systematic process for asking every satisfied customer for a testimonial.", centralLabel: "≈10% request to response", badMax: 0.05, okMax: 0.1, excellentAt: 0.2 },
  communaute_clients: { whatIsThis: "A space such as a Discord server or private group where customers interact with each other and with you." },
