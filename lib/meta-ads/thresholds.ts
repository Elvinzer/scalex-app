...
export const META_INSIGHT_THRESHOLDS = {
  ...
  webinarCostPerRegistrationStability: configuredNumber("META_INSIGHT_WEBINAR_COST_PER_REGISTRATION_STABILITY_PERCENT", 20, 0.1, 100) / 100,
  webinarShowupDecline: configuredNumber("META_INSIGHT_WEBINAR_SHOWUP_DECLINE_PERCENT", 10, 0.1, 100) / 100,
  webinarCostPerParticipantIncrease: configuredNumber("META_INSIGHT_WEBINAR_COST_PER_PARTICIPANT_INCREASE_PERCENT", 20, 0.1, 100) / 100,
  webinarPostQualityStability: configuredNumber("META_INSIGHT_WEBINAR_POST_QUALITY_STABILITY_PERCENT", 20, 0.1, 100) / 100,
  webinarMinRegistrations: Math.round(configuredNumber("META_INSIGHT_WEBINAR_MIN_REGISTRATIONS", 20, 1, 1_000_000)),
  webinarMinParticipants: Math.round(configuredNumber("META_INSIGHT_WEBINAR_MIN_PARTICIPANTS", 10, 1, 1_000_000)),
