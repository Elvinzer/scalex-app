...
export function classifyMetaCampaign(raw: MetaRawObject): { type: MetaCampaignType; confidence: number } {
  ...
  const rules: { type: MetaCampaignType; confidence: number; terms: string[] }[] = [
    { type: "webinar", confidence: 0.92, terms: ["webinar", "masterclass", "workshop", "live training", "webinaire"] },
    { type: "vsl", confidence: 0.9, terms: ["vsl", "video sales letter", "sales video", "video de vente", "video_views", "video_view"] },
    {
      type: "instagram_profile_growth",
      confidence: 0.95,
      terms: ["profile visit", "profile visits", "profile_visits", "followers", "follower", "instagram profile"],
    },
    { type: "retargeting", confidence: 0.85, terms: ["retarget", "remarketing", "warm", "website visitors", "website_visitors", "custom audience", "custom_audience", "engagers"] },
  ];
