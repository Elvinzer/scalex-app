    ...
    <div className="bg-mist">
      ...
      <nav className="sticky top-0 z-50 flex items-center justify-between border-b border-ink/10 bg-mist px-6 py-4 sm:px-12">
        <div className="flex items-center gap-2.5">
          <div className="flex size-8 items-center justify-center rounded-[10px] border border-ink bg-signal font-display text-base font-bold text-ink">
            S
          </div>
        ...
        <div className="flex items-center gap-4">
          <a href="/sign-in" className="hidden text-sm font-bold hover:opacity-65 sm:inline">
            Se connecter
          </a>
          <Button asChild>
      ...
      >
        <span className="rounded-full border border-ink bg-white px-5 py-2 text-[13px] font-bold">
        ...
        <p className="text-[13px] font-bold tracking-wide text-ink/55 uppercase">
        ...
        <div className="sticker-card mt-6 w-full max-w-lg -rotate-1 p-7 text-left">
          <div className="mb-3.5 flex items-center justify-between">
            <span className="rounded-full border border-ink bg-signal px-3 py-1 text-xs font-bold text-ink">
        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-3">
          {PROBLEMS.map((p) => (
            <div key={p.title} className="sticker-card p-8">
              <div className="mb-5 flex size-11 items-center justify-center rounded-xl border border-ink bg-signal font-display text-xl font-bold text-ink">
                {p.tag}
              </div>
            ...
            <div className="flex flex-1 flex-col gap-1">
              {SIDEBAR_ITEMS.map((item) => (
                <div
                  ...
                  className={
                    item.active
                      ? "rounded-lg bg-signal px-3 py-2 text-sm font-bold text-ink"
                      : "px-3 py-2 text-sm font-bold text-mist/70"
                  }
                >
                  {item.label}
                </div>
              ...
              tier.highlight ? (
                ...
                >
                  ...
                  <p className="mb-6 font-display text-4xl font-bold">
                    ${tier.price}
                    <span className="text-base font-bold text-mist/60">/mois</span>
                  </p>
                  {tier.feats.map((feat) => (
                ...
                <div key={tier.key} className="sticker-card flex h-full flex-col px-8 py-9">
                  ...
                  <p className="mb-6 font-display text-4xl font-bold">
                    ${tier.price}
                    <span className="text-base font-bold text-muted-foreground">/mois</span>
                  </p>
                  {tier.feats.map((feat) => (
