  ...
  return (
    <section className="sticker-card p-5 sm:p-6" aria-labelledby="journal-reminders-title" data-testid="journal-reminders">
      <div className="flex items-start justify-between gap-4">
        ...
        <Link href="/crm/pipeline" className="inline-flex min-h-11 items-center text-xs font-bold text-muted-foreground underline-offset-4 hover:text-foreground hover:underline">{t("openPipeline")} <ArrowRight className="ml-1 size-3.5" aria-hidden="true" /></Link>
      </div>
