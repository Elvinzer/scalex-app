...
// Moved from app/(app)/funnel/insights/page.tsx (was its own route) — now
// the "Insights" tab inside Diagnostic; see funnel-tab.tsx for why this
// doesn't repeat its own permission check.
export async function InsightsTab({ accountId }: { accountId: string }) {
  ...
  return (
    <div className="flex flex-col gap-8">
      <p className="text-sm text-muted-foreground">
        Tout ce que l&apos;agent t&apos;a déjà suggéré sur ton funnel, et ce que tu as réellement
        mis en place.
      </p>
