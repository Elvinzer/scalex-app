  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <form method="get" className="sticker-card grid gap-3 p-4 sm:grid-cols-2 lg:grid-cols-6 lg:items-end">
        ...
        <label className="flex flex-col gap-1 text-sm font-bold lg:col-span-2">{t("kpis.from")}<input name="from" type="date" defaultValue={dateValue(period.from)} className="min-h-11 rounded border border-border bg-background px-2 font-normal outline-none focus-visible:border-accent" /></label>
        <label className="flex flex-col gap-1 text-sm font-bold lg:col-span-2">{t("kpis.to")}<input name="to" type="date" defaultValue={dateValue(period.to)} className="min-h-11 rounded border border-border bg-background px-2 font-normal outline-none focus-visible:border-accent" /></label>
