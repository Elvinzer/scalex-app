...
import type { EditableClosingKpiField } from "@/lib/closing/schema";

import { updateClosingKpiEntryField } from "./actions";
...
export function EditableKpiCell({
  ...
  function commit() {
    ...
    startTransition(async () => {
      const result = await updateClosingKpiEntryField(entryId, field, parsed);
      if (result.error) {
