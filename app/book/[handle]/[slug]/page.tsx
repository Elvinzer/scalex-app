...
// Pages de réservation : transactionnelles et par-client, aucun objectif SEO.
export const metadata: Metadata = {
  robots: { index: false, follow: false },
};

export default async function PublicBookingRoute({ params }: { params: Promise<{ handle: string; slug: string }> }) {
