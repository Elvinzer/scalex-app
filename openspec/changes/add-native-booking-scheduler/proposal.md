...
Le parcours public doit aussi qualifier le prospect avant de révéler les créneaux, comme le parcours iClosed observé dans le screenshot fourni, afin de sécuriser les coordonnées et d’éviter les réservations multiples.
...
- `public-booking-flow`: collecte d’informations avant révélation des créneaux, sélection horaire, fuseaux, contrôle des rendez-vous futurs et confirmation.
- `booking-attribution`: liens de réservation nommés, capture UTM et rattachement de la source à la réservation et à l’appel de vente.
