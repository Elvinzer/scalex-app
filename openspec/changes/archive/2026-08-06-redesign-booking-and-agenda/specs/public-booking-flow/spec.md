...
Lorsqu’une réservation est confirmée et synchronisée, le système SHALL créer ou mettre à jour un appel de vente avec la source `native`, le nom, l’email, le téléphone, l’horaire, le closer attribué, l’identifiant de réservation, les réponses de qualification et l’attribution disponible. Une répétition de la même confirmation SHALL être idempotente.
